...
results  = {
    "fn_rsiBet" :fn_rsiBet(),
    "fn_mfiCg"  :fn_mfiCg(),
    "fn_maCrossOver_30" : fn_maCrossOver(30),
    "fn_maCrossOver_180" : fn_maCrossOver(180),
    "fn_maCrossUnder_30" : fn_maCrossUnder(30),
    "fn_maCrossUnder_180" : fn_maCrossUnder(180),
    "fn_candleDoji" : fn_candleDoji(30,70),
    "fn_CehckDivergence_rsi_14" : fn_CehckDivergence(close_prices,rsi_14,70),
    "fn_CehckDivergence_mfi_14" : fn_CehckDivergence(close_prices,mfi_14,70),
    "fn_candleHammer" : fn_candleHammer(close_prices[-1:],open_prices[-1:],high_prices[-1:],low_prices[-1:]),
    "fn_candleInverseHammer" : fn_candleInverseHammer(close_prices[-1:],open_prices[-1:],high_prices[-1:],low_prices[-1:])
